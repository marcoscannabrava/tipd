export default function LoginPage() {
  return (
    <div className="min-h-screen bg-white flex flex-col">
      <div className="p-6">
        <p className="text-2xl font-bold text-gray-800">Tipd</p>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-4">
        <div className="w-full max-w-md">
          ...
          <div className="space-y-3">
            <button className="w-full py-3 rounded-full border border-gray-200 bg-white hover:bg-gray-50 transition-colors flex items-center justify-center gap-2 cursor-pointer">
              <svg
          ...
          <div className="text-center mt-8">
            <p className="text-gray-600 text-sm">
              New to Tipd?{" "}
              <a href="#" className="text-gray-800 font-semibold hover:underline pl-2">
                Sign up here
              </a>
            </p>
          </div>
